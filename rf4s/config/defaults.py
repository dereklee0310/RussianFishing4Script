...
_C.PROFILE.PAUSE_SPIN.RETRIEVAL_DURATION = 1.0
_C.PROFILE.PAUSE_SPIN.RETRIEVAL_DELAY = 3.0
...
_C.PROFILE.LIFT_SPIN.RETRIEVAL_DURATION = 1.0
_C.PROFILE.LIFT_SPIN.RETRIEVAL_DELAY = 1.0
