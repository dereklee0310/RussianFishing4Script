...
_C.NOTIFICATION.SMTP_SERVER = "smtp.example.com"
...
_C.PROFILE.SPECIAL_SPIN = CN()
_C.PROFILE.SPECIAL_SPIN.MODE = "spin"
_C.PROFILE.SPECIAL_SPIN.CAST_POWER_LEVEL = 5.0
_C.PROFILE.SPECIAL_SPIN.CAST_DELAY = 6.0
_C.PROFILE.SPECIAL_SPIN.TIGHTEN_DURATION = 1.0
_C.PROFILE.SPECIAL_SPIN.RETRIEVE_DURATION = 1.1
_C.PROFILE.SPECIAL_SPIN.RETRIEVE_DELAY = 3.0
_C.PROFILE.SPECIAL_SPIN.PRE_ACCELERATION = False
_C.PROFILE.SPECIAL_SPIN.POST_ACCELERATION = "off"
...
_C.PROFILE.PIRK.DEPTH_ADJUST_DURATION = 4.0
